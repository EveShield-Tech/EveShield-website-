...
(function () {
  ...
  var chartInstances = [];
  var chartJsLoading = false; // Flag to prevent duplicate loading
  ...
  var pages = {
    ...
    '/data': () => {
      ...
      <!-- EXECUTIVE SUMMARY: GBV TRENDS 2025-2026 -->
      <section class="section-padding bg-background">
        <div class="section-wrapper">
          <div class="container-narrow">
            <div class="text-center mb-12">
              <h2 class="text-3xl text-sm-4xl font-display font-bold mb-4">
                Executive Summary: <span class="gradient-purple-text">GBV Trends in Kenya (2025-2026)</span>
              </h2>
              <p class="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Latest data reveals critical trends in gender-based violence, highlighting emerging threats and the urgent need for innovative solutions.
              </p>
            </div>
     ...
     <div class="glass-card counter-card glow-purple-hover" data-end="72" data-suffix="%">
                ...
                <p class="counter-description">of femicide cases occur within the home.</p>
                <p class="counter-source">2025 Crime Statistics</p>
              </div>
              <div class="glass-card counter-card glow-purple-hover" data-end="40" data-suffix="%">
                <div class="counter-value gradient-purple-text">0%</div>
                <p class="counter-label">Intimate Partner Violence</p>
                <p class="counter-description">of women report emotional or physical abuse by partners.</p>
                <p class="counter-source">KDHS 2025</p>
              </div>
              <div class="glass-card counter-card glow-purple-hover" data-end="30" data-suffix="%">
                <div class="counter-value gradient-purple-text">0%</div>
                <p class="counter-label">Violence Justification</p>
      ...
      <section class="section-padding gradient-section">
        <div class="section-wrapper">
          <div class="container-narrow">
            <div class="text-center mb-8">
              <h3 class="text-2xl text-sm-3xl font-display font-bold mb-4">
                <span class="gradient-purple-text">Emerging Threats</span> in GBV
              </h3>
              <p class="text-muted-foreground max-w-2xl mx-auto">
                New challenges identified in the 2025 reporting cycle require innovative responses.
              </p>
            </div>

            <div class="grid grid-cols-1 grid-cols-sm-2 gap-6">
              <div class="glass-card p-6 p-sm-8 glow-blue-hover">
                <div class="flex items-center mb-4">
                  <span class="text-3xl mr-3">💻</span>
                  <h4 class="font-display font-semibold text-lg">Digital Violence</h4>
                </div>
                <p class="text-foreground mb-4">
                  Sharp rise in technology-facilitated GBV, including online stalking and AI-driven harassment.
                </p>
                <div class="bg-blue-25 p-4 rounded-lg">
                  <p class="text-sm text-blue-900">
                    <strong>Key Concern:</strong> Perpetrators using technology to extend abuse beyond physical boundaries.
                  </p>
                </div>
              </div>

              <div class="glass-card p-6 p-sm-8 glow-orange-hover">
                <div class="flex items-center mb-4">
                  <span class="text-3xl mr-3">🌍</span>
                  <h4 class="font-display font-semibold text-lg">Climate-Related Risks</h4>
                </div>
                <p class="text-foreground mb-4">
                  Regions hit by extreme weather saw a 60% increase in GBV cases due to displacement.
                </p>
                <div class="bg-orange-25 p-4 rounded-lg">
                  <p class="text-sm text-orange-900">
                    <strong>Key Concern:</strong> Breakdown of community protection structures during climate crises.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section class="section-padding bg-background">
        <div class="section-wrapper">
          <div class="container-narrow">
            <h3 class="text-2xl text-sm-3xl font-display font-bold text-center mb-8">
              <span class="gradient-purple-text">Prevalence Data</span> - KDHS 2025 Update
            </h3>
            ...
            <div class="grid grid-cols-1 grid-cols-sm-2 grid-cols-lg-3 gap-6 mb-8">
              <div class="glass-card counter-card glow-purple-hover" data-end="34" data-suffix="%">
                <div class="counter-value gradient-purple-text">0%</div>
                <p class="counter-label">Physical Violence</p>
                <p class="counter-description">of women (ages 15-49) have experienced physical violence.</p>
                <p class="counter-source">KDHS 2025</p>
              </div>
              <div class="glass-card counter-card glow-purple-hover" data-end="16" data-suffix="%">
                <div class="counter-value gradient-purple-text">0%</div>
            ...
            <div class="grid grid-cols-1 grid-cols-sm-2 gap-6">
              ...
              <div class="glass-card counter-card glow-purple-hover" data-end="19" data-suffix="%">
                <div class="counter-value gradient-purple-text">0%</div>
                <p class="counter-label">Male Justification</p>
                <p class="counter-description">of men still believe physical discipline is justified.</p>
                <p class="counter-source">KDHS 2025</p>
              </div>
            </div>
          </div>
  ...
  function initContactForm() {
    ...
    function validateForm(formData) {
      ...
      if (phone && phone.trim()) {
        // More flexible phone regex - allows international formats, spaces, dashes, plus, parentheses
    ...
    function showValidationErrors(errors) {
      ...
      errors.forEach(function(error) {
        ...
        if (errorLower.includes('email')) {
          ...
          field = form.querySelector('[name="phone"]');
        } else if (errorLower.includes('city')) {
          field = form.querySelector('[name="city"]');
        } else if (errorLower.includes('interest') || errorLower.includes('area')) {
          field = form.querySelector('[name="interest"]');
        }
  ...
  var earlyAccessCounter = {
    ...
    getCurrentCount: function () {
      try {
        ...
        return this.baseCount; // Fallback to base count
      }
    },
    ...
    updateDisplay: function () {
      ...
      textCounters.forEach(function (element) {
        if (element.textContent.includes('People Already Joined')) {
          // Safe approach: create text node instead of using innerHTML
          var iconSpan = document.createElement('span');
          iconSpan.className = 'icon-text';
          iconSpan.textContent = '📈';
          
          var textSpan = document.createElement('span');
          textSpan.className = 'text-sm text-primary font-medium';
          textSpan.textContent = count + '+ People Already Joined';
    ...
    incrementCounter: function () {
      ...
      try {
        ...
        // Still update display even if localStorage fails
        this.baseCount = newCount;
        this.updateDisplay();
      }
    },
        ...
        setTimeout(function () {
          ...
          if (currentPath === '/data') {
            setTimeout(function () {
              ...
              if (typeof Chart === 'undefined' && !chartJsLoading) {
                // If Chart.js is not loaded and not already loading, load it
                chartJsLoading = true; // Set loading flag
                ...
                const timeoutId = setTimeout(function () {
                  ...
                  chartJsLoading = false; // Reset loading flag
                ...
                // Chart.js is currently loading, wait a bit longer
                setTimeout(function() {
                  if (typeof Chart !== 'undefined') {
                    initCharts();
                  }
